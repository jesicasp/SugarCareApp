...
class ProductRecRecyclerViewAdapter(private val values: List<PlaceholderContent.PlaceholderItem2>
) : RecyclerView.Adapter<ProductRecRecyclerViewAdapter.ViewHolder>() {
