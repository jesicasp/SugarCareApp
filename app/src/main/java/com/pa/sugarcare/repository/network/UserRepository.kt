...
class UserRepository {
    ...
    suspend fun getWeeklyConsumption(sugarReportId: Int): Response<CommonResponse<List<WeeklyChartResponse>>> {
        return apiService.getWeeklyConsumption(sugarReportId)
    }
